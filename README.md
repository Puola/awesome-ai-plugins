...
- [GPT-6 Astra Outbound System](https://github.com/heypastel/pastel-outbound-system) - Codex plugin with 17 sales skills and 14 agents that find LinkedIn leads showing buying intent, research and score them, draft outreach, run sequences, and triage replies through the Pastel MCP, with every send approved first.
